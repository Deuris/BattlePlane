package com.samofan.denys.battleplane.main;
...
import com.samofan.denys.battleplane.R;
import com.samofan.denys.battleplane.components.Background;
import com.samofan.denys.battleplane.components.BotBorder;
import com.samofan.denys.battleplane.components.Explosion;
import com.samofan.denys.battleplane.components.Player;
import com.samofan.denys.battleplane.components.Rocket;
import com.samofan.denys.battleplane.components.SmokePuff;
import com.samofan.denys.battleplane.components.TopBorder;
...
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback
{
    ...
    private ArrayList<Rocket> missiles;
...

    {
        if(player.getPlaying()) {
            ...
            if(missileElapsed >(2000 - player.getScore()/4)){
                ...
                if(missiles.size()==0)
                {
                    missiles.add(new Rocket(BitmapFactory.decodeResource(getResources(),R.drawable.
                            missile),WIDTH + 10, HEIGHT/2, 45, 15, player.getScore(), 13));
                }
                else
                {

                    missiles.add(new Rocket(BitmapFactory.decodeResource(getResources(),R.drawable.missile),
